 ...
 *
 */
export type AudioClip = { id: string, trackId: string, assetId: AssetId, startTick: number, sourceRange: FrameRange, sourceSampleRate: number, timelineDuration: FrameDuration, gainDb: number, pan: number, fadeIn: FrameDuration, fadeOut: FrameDuration, loopEnabled: boolean, muted: boolean, name: string, recordingTakeId?: string, takeVariant: AudioTakeVariant, };
