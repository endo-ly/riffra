...
function ReferenceSuggestion({ analysis, recordings, references, referenceId, session, setSession, onSelect, onPreview, onStop, previewingId }: { analysis: AudioAnalysis | null; recordings: RecordingAsset[]; references: Record<string, AudioAnalysis>; referenceId: string | null; session: ScratchSession; setSession: (value: ScratchSession) => void; onSelect: (recording: RecordingAsset) => void; onPreview: (recording: RecordingAsset) => void; onStop: () => void; previewingId: string | null }) {
  ...
  return <>
    ...
    <ReferenceCompare analysis={analysis} recordings={recordings} references={references} referenceId={referenceId} onSelect={onSelect} onPreview={onPreview} onStop={onStop} previewingId={previewingId} />
