 ...
 */
export type RuntimeProjectionStatus = { state: RuntimeProjectionState, operationId: number, runningOperationId: number | null, targetSessionRevision: number | null, activeSessionRevision: number | null, runtimeGeneration: number, queuedAtMs: number | null, startedAtMs: number | null, completedAtMs: number | null, lastError: string | null, };
