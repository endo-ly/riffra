 ...
 */
export type RuntimeProjectionStatus = { state: RuntimeProjectionState, operationId: number, runningOperationId: number | null, targetSessionRevision: number | null, preparedSessionRevision: number | null, activeSessionRevision: number | null, runtimeGeneration: number, queuedAtMs: number | null, startedAtMs: number | null, completedAtMs: number | null, lastNativeResponseAtMs: number | null, discardedPreparationCount: number, lastError: string | null, };
