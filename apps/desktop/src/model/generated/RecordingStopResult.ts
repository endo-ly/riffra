 ...
 */
export type RecordingStopResult = { session: CreativeSession, audio: AudioStatus, projection: ArrangementProjectionOutcome, finalization: RecordingFinalizationOutcome, };
