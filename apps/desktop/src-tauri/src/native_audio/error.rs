...
pub(crate) type NativeAudioResult<T> = Result<T, NativeAudioError>;

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum NativeAudioError {
...
impl NativeAudioError {
    pub(crate) fn transport_lost(message: impl Into<String>) -> Self {
        Self::TransportLost {
            message: message.into(),
        }
    }

    pub(crate) fn native_rejected(message: impl Into<String>) -> Self {
        Self::NativeRejected {
            message: message.into(),
        }
    }
