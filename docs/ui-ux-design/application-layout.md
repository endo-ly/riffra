...
選択するとpopoverが開き、PROJECTとHOSTのセクションを提供する。PROJECTではProject一覧、新規作成、Active Projectの改名、Export ProjectとImport Projectを実行する。Import Projectはファイルダイアログでproject.jsonマニフェストを選択し、現在のProjectを上書きせず新しいProjectとして開く。
