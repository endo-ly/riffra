...
| I. Creative Memory | library catalog + provenance manifests | In progress | VST3 catalog, recording-manifest search/listing and rack/session provenance sidecars are available; SQLite cross-asset index, related assets and non-destructive preview remain |
