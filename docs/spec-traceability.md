...
| D. Arrange | timeline engine + offline render | In progress | non-destructive Inbox audio clip references with editable position/gain/mute and a new stereo float WAV render with bounded master gain; MIDI edit, PDC and stem export remain |
