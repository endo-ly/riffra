...
| E. Sample | sampler preview bus + MIDI monitor | In progress | non-destructive source-to-pad mapping with editable slice range, native safety-limited WAV audition, mouse/Z–M keyboard pad audition, Windows MIDI port discovery, explicit input monitoring and preloaded MIDI-triggered pad playback with trigger counters; polyphony and MIDI recording remain |
