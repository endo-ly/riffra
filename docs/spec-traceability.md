...
| E. Sample | sampler engine | In progress | non-destructive source-to-pad mapping with slice range and MIDI key; sampler playback, slicing UI and MIDI play/record remain |
