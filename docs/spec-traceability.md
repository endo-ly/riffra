...
| D. Arrange | timeline engine + offline render | In progress | non-destructive Inbox audio clip references with editable position/gain/fade/pan/mute, new stereo float WAV render with bounded master gain, and safe rendered-audio preview; MIDI edit, PDC and stem export remain |
