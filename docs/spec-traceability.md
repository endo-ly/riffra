...
| I. Creative Memory | library catalog + provenance manifests | In progress | VST3 catalog, recording-manifest search/listing, SQLite cross-asset index/search, editable tag/note metadata, related-asset traversal, rack/session provenance sidecars and portable session export that collects referenced audio into an assets folder are available; non-destructive preview remains |
