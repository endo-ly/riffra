...
| D. Arrange | timeline engine + offline render | In progress | non-destructive Inbox audio clip references with editable position/source range/loop/gain/fade/pan/mute, duplicate/split clip operations, bounded range/normalize stereo float WAV render with master gain, and safe rendered-audio preview; MIDI edit, PDC and stem export remain |
