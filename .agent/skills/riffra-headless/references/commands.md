...
riffra --attach plugin state get --track-id track:01j... --device-id device:01j...
riffra --attach plugin state set --track-id track:01j... --device-id device:01j... --state-json '{...}'
